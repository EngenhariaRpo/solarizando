...
def gerar_pdf_proposta(dados, img_geracao_buffer):
    ...
    y = desenhar_paragrafo_pdf(c, "Telefone: (86) 98822-3936", 45, y, largura=490)
    y = desenhar_paragrafo_pdf(c, "E-mail: rpoengenhariapi@gmail.com", 45, y, largura=490)
    ...
    y = desenhar_paragrafo_pdf(
        c,
        "O inversor converte a energia de corrente contínua dos painéis em corrente alternada, que pode ser usada na casa.",
        50, y, largura=490
    )
    y -= 10
